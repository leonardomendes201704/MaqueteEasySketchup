module LeonardoLabs
  module PlanForgeBuilder
    class RoomTool
      ...
      def draw_label(view)
        label = "#{Sketchup.format_length(@interior_width)} x #{Sketchup.format_length(@interior_depth)}"
      ...
      def update_vcb
        value = "#{Sketchup.format_length(@interior_width)} x #{Sketchup.format_length(@interior_depth)}"
