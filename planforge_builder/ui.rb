    ...
    class SettingsDialog
      ...
      class << self
        ...
        def build_dialog
          ...
          panel.add_action_callback('activateRoomTool') do |_context|
            success = PlanForgeBuilder.prompt_room_tool
            push_state(success ? 'Ferramenta de comodo ativa. Informe as medidas em metros, posicione o canto inferior e clique para gerar.' : 'Geracao de comodo cancelada.')
          end
